...
- [claude-blog-assistant](https://github.com/johnericforte/claude-skill-blog-assistant) - Wraps AgriciDaniel/claude-blog (28 sub-skills) into a publishing lifecycle. Mode 1 ships new posts through 8 gates (brief, write, voice cleanup, SEO check, schema, analyze, repurpose, final QA). Mode 2 retroactively scores published posts and returns a Top 3-5 Retrofit List. *By [@johnericforte](https://github.com/johnericforte)*
