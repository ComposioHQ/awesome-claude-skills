...
- [Raysurfer Code Caching](https://github.com/rayxc-org/raysurfer-code-caching-skill) - LLM output caching skill for Claude Code. Searches cache before coding, uploads after success. Retrieves cached outputs up to 30x faster. *By [@rayxc-org](https://github.com/rayxc-org)*
