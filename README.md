...
- [Claude Plugins Marketplace](./claude-plugins-marketplace/) - A curated marketplace of 25+ open-source Claude Code plugins and MCP servers for development, testing, code review, and business workflows from 2389 Research. Includes simmer (iterative refinement), test-kitchen (parallel exploration), fresh-eyes-review (pre-commit checks), and review-squad (multi-agent code review). *By [@2389-research](https://github.com/2389-research)*
