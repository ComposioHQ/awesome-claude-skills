...
- [LobsterMail](https://lobstermail.ai/) - Email infrastructure for AI agents via MCP server. Agents self-provision inboxes — no human signup, no API keys. Includes prompt injection scanning and SPF/DKIM/DMARC. *By [@samuelchenard](https://x.com/samuelchenard)*
