...
- [Sober Coding](https://github.com/voidborne-d/sober-coding) - The hangover cure for vibe coding. Language-agnostic CLI that scans AI-generated codebases for 27 types of issues across 7 dimensions (security, architecture, duplication, error handling, dependencies, testing, dead code) with fix suggestions and CI mode. *By [@voidborne-d](https://github.com/voidborne-d)*
