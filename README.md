...
- [Rich Elicitation](https://github.com/CyberZenithX/Rich-Elicitation-Skill) - A Claude skill that asks clarifying questions across multiple rounds to resolve task ambiguity before you start working and reduces bad first drafts.
