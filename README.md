...
- [HAM (Hierarchical Agent Memory)](https://github.com/kromahlusenii-ops/ham) - Scoped CLAUDE.md files per directory that reduce agent token spend by 80-90%. Auto-detects platform and project maturity, self-maintains memory, and suggests periodic audits. *By [@kromahlusenii-ops](https://github.com/kromahlusenii-ops)*
