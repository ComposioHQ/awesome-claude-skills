...
- [Data Scraper Agent](./data-scraper-agent/) - Builds a fully automated AI-powered data collection agent for any public source (job boards, prices, news, GitHub, sports). Scrapes on a schedule via GitHub Actions, enriches each result with Gemini Flash AI scoring and summaries, stores to Notion, and learns from your decisions over time. 100% free. *Inspired by [@imrobinsingh](https://github.com/imrobinsingh)*
