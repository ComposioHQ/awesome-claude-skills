...
- [Playwright Testing Patterns](https://github.com/testdino-hq/playwright-skill) - 70+ production-tested Playwright automation testing patterns: E2E, POM, CI/CD, migrations, CLI. *By [@testdino-hq](https://github.com/testdino-hq)*
