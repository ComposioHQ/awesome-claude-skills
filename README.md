...
- [mycrab-tunnel-skill](https://github.com/isgudtek/mycrab-tunnel-skill) - Autonomous Cloudflare Tunnel setup via mycrab.space API. One-click tunnel install, tunnel management, custom domains, and 12+ 1-click templates for agents.
