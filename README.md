...
- [Alpha Insights](https://github.com/Ericyoung-183/alpha-insights) - Professional business analysis skill with 19 frameworks (Porter's Five Forces, BCG Matrix, MECE, etc.), multi-source data triangulation, harness-enforced quality gates, and structured HTML report generation. Covers industry research, competitive analysis, market entry, due diligence, and 10 business scenarios. *By @Ericyoung-183*
