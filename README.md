...
- [multi-archetype-audit](./multi-archetype-audit/) - Comprehensive code audit using **19 specialized archetypes** covering API, Performance, Security, AI Safety, Resilience, Observability and more for multi-perspective code quality analysis. Includes `--quick`, `--security`, `--performance` presets. *By [@sebaboubou-max](https://github.com/sebaboubou-max)*
