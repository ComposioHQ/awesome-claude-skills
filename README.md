...
- [moyu](https://github.com/uucz/moyu) - Anti-over-engineering skill that teaches AI restraint. 5 variants (zh/en/ja/lite/strict), 10 platforms. Benchmarked: 66% code reduction. *By [@uucz](https://github.com/uucz)*
