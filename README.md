...
- [vibe-coding-cn](https://github.com/earyantLe/vibe-coding-skill) - Chinese-language skill for AI-assisted programming using Vibe Coding methodology with Glue Coding, Canvas-driven development, and 12-layer language elements. *Inspired by [tukuaiai/vibe-coding-cn](https://github.com/tukuaiai/vibe-coding-cn)*
