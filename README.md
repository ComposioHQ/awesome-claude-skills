...
- [crw](https://github.com/us/crw) - Open-source web scraper with built-in MCP server for Claude. Scrape, crawl, map, and extract structured data from any website. Install: `cargo install crw-mcp && claude mcp add crw -- crw-mcp`. *By [@us](https://github.com/us)*
