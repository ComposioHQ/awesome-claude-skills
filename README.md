...
- [Ejentum Reasoning Harness](https://github.com/ejentum/ejentum-mcp/tree/main/skills) - Four SKILL.md files (reasoning, code, anti-deception, memory) for Claude Code, routing to the [ejentum-mcp](https://github.com/ejentum/ejentum-mcp) MCP server. *By [@ejentum](https://github.com/ejentum)*
