...
- [Spring Grimoire](https://github.com/SegfaultSorcerer/spring-grimoire) - Claude Code plugin for Spring Boot development — code reviews, JPA audits, security checks, test generation, Dockerfiles, API design reviews, and Boot 2→3 migration analysis. Benchmarked at 98.7% pass rate vs. 79.3% baseline. *By [@SegfaultSorcerer](https://github.com/SegfaultSorcerer)*
