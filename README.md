...
- [learning-from-experience](https://github.com/game1991/claude-skills/tree/main/skills/learning-from-experience) - Auto Memory remembers, LFE upgrades - turns experience into reusable SKILL.md, script/MCP proposals, or rule-to-skill upgrades. Complements built-in memory, does not duplicate it. *By [@luckystar520](https://github.com/game1991)*
