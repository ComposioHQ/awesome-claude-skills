...
- [skillguard](https://github.com/nardovibecoding/skillguard) - Scan Claude Code skills for malicious code, prompt injection, and exfiltration before installation. 60 detection patterns, 14 threat categories, PASS/WARN/FAIL verdicts.
