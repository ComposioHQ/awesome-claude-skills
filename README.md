...
- [SkillCheck](https://github.com/olgasafonova/SkillCheck-Free) - Validates SKILL.md files against the agentskills specification for structure, naming, and semantics. Free CLI and MCP server; [Pro](https://getskillcheck.com) adds anti-slop, WCAG, enterprise, and token efficiency checks. *By [@olgasafonova](https://github.com/olgasafonova)*
