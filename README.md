...
- [zip-code-and-county](./zip-code-and-county/) - Look up any US ZIP code (city, county FIPS, timezone, area codes, Census ACS demographics, home prices, rent, property tax, broadband, cost of living) via the hosted zipcodeandcounty.com MCP server. Free for low-volume use.
