...
- [TokRepo](https://tokrepo.com) - Free, open registry of 500+ agent skills, MCP servers, prompts, and workflows for Claude Code, Cursor, Codex CLI, and Gemini CLI. Provides CLI and MCP server with 4 tools: search, detail, install, trending.
