...
- [agent-manager-skill](https://github.com/fractalmind-ai/agent-manager-skill) - Simple, installation-agnostic agent lifecycle management using tmux + Python. *By [@fractalmind-ai](https://github.com/fractalmind-ai)*
