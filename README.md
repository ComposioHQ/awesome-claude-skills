...
- [everyrow](https://github.com/futuresearch/everyrow-sdk/tree/main/skills/everyrow-sdk) - Run AI web research agents on every row of a dataframe, plus intelligent operations like semantic deduping, fuzzy merging, qualitative ranking, and screening.
