...
- [readme-demo-recorder](https://github.com/cjcsecurity/readme-demo-recorder) - Scripted-flow browser demo recorder for README hero assets. YAML demo-script in; polished MP4 + GIF out with a visible fake cursor + click pulse, three cursor styles (pulse / minimal / crosshair), timed caption overlays via ffmpeg drawtext, and an automatic 7-step quality ladder that auto-fits the GIF under GitHub's 10 MB inline cap. Built on Playwright + ffmpeg. *By [@cjcsecurity](https://github.com/cjcsecurity)*
