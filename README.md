...
- [Dev Skills](https://github.com/phbpx/dev-skills) - Suite of 10 language-agnostic development workflow skills covering the full lifecycle from brainstorming to pull requests, with TDD, parallel code review, and plan-driven execution. *By [@phbpx](https://github.com/phbpx)*
