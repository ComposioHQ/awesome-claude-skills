...
- [VibeCheck](https://github.com/akshan-main/vibe-check) - One-question quiz after every task based on your exact diff. Tests if you understand what your product actually does now, not how the code works. Rust binary, sub-millisecond startup, works with Claude Code, Cursor, Windsurf, and anything that uses git.
