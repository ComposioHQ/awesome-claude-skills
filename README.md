...
- [dev-card](https://github.com/likw99/agent-skills/tree/main/skills/dev-card) - Generates a shareable Developer Identity Card from git history — assigns one of 11 developer archetypes ("The Midnight Architect", "The Dawn Deployer", "The Firefighter") with a personality tagline and stats. Includes a pre-filled X/Twitter share link. *By [@likw99](https://github.com/likw99)*
