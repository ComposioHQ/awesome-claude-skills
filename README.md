...
- [Genealogy Research](https://paulo.com.br/skills/genealogy-research/SKILL.md) - Full-lifecycle genealogy research agent: interviews, OCR, FamilySearch API, YAML data management, and human-in-the-loop coordination for tracing family history. *By [@peas](https://github.com/peas)*
