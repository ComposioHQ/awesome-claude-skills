...
- [neo4j](https://github.com/neo4j-contrib/neo4j-skills) - Skills for Cypher generation, app development, driver usage, upgrades, agent-memory for [Neo4j](https://neo4j.com/llms.txt)
