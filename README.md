...
- * [SpecVibe](https://github.com/badideal-2046/SpecVibe ) - A complete spec-driven framework for building production-ready AI-native apps, covering the entire lifecycle from specification to deployment.
