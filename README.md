...
- [Tidy](https://github.com/Jacknelson6/tidy) - Audit and clean up codebase structure for Claude Code. Detects god files, junk drawer roots, deep nesting, barrel export mazes, and bloated CLAUDE.md files. Estimates token waste per issue and reports savings after cleanup. One command: `/tidy`. *By [@JackHnels](https://github.com/Jacknelson6)*
