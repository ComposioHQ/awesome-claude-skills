...
- [Multi-AI Agents](./multi-ai-agents/) - Distribute tasks across Claude, Gemini CLI, and Codex CLI in parallel using x3/x5/x7 shorthand. Claude orchestrates while Gemini analyzes and Codex generates code. *By [@arslanibrahim95](https://github.com/arslanibrahim95)*
...
- [Typefix](./typefix/) - Detect, categorize, and systematically fix TypeScript type errors. Scans with `tsc --noEmit`, groups errors by category and file, fixes them with minimal changes, and verifies the result. *By [@arslanibrahim95](https://github.com/arslanibrahim95)*
...
- [Kickstart](./kickstart/) - Start any new project with a structured co-founder session. Claude asks 5 critical questions, builds a master plan, creates knowledge base directories with context files, and sets up the skeleton for 10x faster execution. *By [@arslanibrahim95](https://github.com/arslanibrahim95)*
