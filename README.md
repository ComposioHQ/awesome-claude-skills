...
- [Useful AI](https://github.com/uAI-solana/useful-ai-skills) - Shared utility tool library for agents. Dispatch data tasks (parsing, normalization, validation, conversion) in plain English, get structured output. 200+ tools, auto-generated, no auth. *By [@uAI-solana](https://github.com/uAI-solana)*
