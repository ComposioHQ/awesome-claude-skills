...
- [next-intl-i18n](./next-intl-i18n/) - Set up and maintain multilingual Next.js App Router apps with next-intl: locale routing, RSC/client boundaries, TypeScript types, middleware, pluralization, and common pitfalls. By [@Yosolita1978](https://github.com/Yosolita1978)
