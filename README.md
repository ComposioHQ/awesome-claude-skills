...
- [python-venv](./python-venv/) - Enforce Python virtual environment usage for third-party packages before running scripts or installing packages. Supports uv and venv with automatic environment detection and reuse. Prevents dependency conflicts and ensures reproducible setups. *By [@cikichen](https://github.com/cikichen)*
