...
- [harness-engineering](https://github.com/Junhanliu-dev/harness-engineering) - Discovers an existing codebase's patterns and generates a Harness Engineering structure (rules, skills, agents, hooks, 10-stage pipeline) tailored to the project. TS/Go/Python layer-boundary hooks, programmatic quality gates, sub-agent separation of execution and judgment. *By [@Junhanliu-dev](https://github.com/Junhanliu-dev)*
