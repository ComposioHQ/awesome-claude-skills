...
- [skill-guide](https://github.com/VV1NN/skill-guide) - Scans all installed skills and slash commands, then explains them in the user's native language with categorized overviews, workflow recommendations, dependency checks, and skill pack comparison. *By [@VV1NN](https://github.com/VV1NN)*
