...
- [Sequenzy Email Marketing](https://github.com/Sequenzy/skills/tree/main/skills/sequenzy-email-marketing) - Operate Sequenzy email marketing and transactional/product email workflows from AI agents: subscribers, campaigns, sequences, templates, sending, and usage checks. *By [@Sequenzy](https://github.com/Sequenzy)*
