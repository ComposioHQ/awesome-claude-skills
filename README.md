...
- [MyVibe Skills](https://github.com/ArcBlock/myvibe-skills) - Publish web projects to a permanent live URL with a single command. Auto-detects project type (Static, Vite, Next.js, Astro, Nuxt), builds if needed, and deploys in seconds with zero configuration. *By [@ArcBlock](https://github.com/ArcBlock)*
