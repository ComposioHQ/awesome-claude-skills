...
- [Aufgaard](https://github.com/temurkhan13/aufgaard) - Production AI Operations plugin bundling 7 MCPs + 13 skills + 6 hooks + 5 monitors. Catches dangerous bash, cost spikes, agent-config attacks, output-action divergence, silent cron failures, supply-chain risks, and unsafe upgrades. Operator cockpit for production AI. *By [@temurkhan13](https://github.com/temurkhan13)*
