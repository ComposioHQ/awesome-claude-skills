...
- [Den](https://github.com/us/den) - Self-hosted sandbox runtime for AI agents. MCP server for Claude with secure containers for code execution. *By [@us](https://github.com/us)*
