...
- [MemStack](./memstack/) - Persistent project context framework that auto-loads tech stack, file structure, coding patterns, and task history into every Claude Code session. *By [@cwinvestments](https://github.com/cwinvestments)*
