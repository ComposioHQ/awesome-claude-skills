...
- [lightning-architecture-review](https://github.com/8144225309/superscalar-mcp/tree/master/skills/lightning-architecture-review) - Analyze Bitcoin Lightning Network protocol designs including trust models, on-chain footprint, HTLC/PTLC compatibility, and liveness guarantees for channel factory architectures. *By [@8144225309](https://github.com/8144225309)*
- [lightning-channel-factories](https://github.com/8144225309/superscalar-mcp/tree/master/skills/lightning-channel-factories) - Reference for Lightning channel factories and Layer 2 scaling using the SuperScalar protocol with Decker-Wattenhofer trees, MuSig2, and Taproot — no soft fork required. *By [@8144225309](https://github.com/8144225309)*
- [lightning-factory-explainer](https://github.com/8144225309/superscalar-mcp/tree/master/skills/lightning-factory-explainer) - Explain Bitcoin Lightning channel factories and the SuperScalar protocol for scalable Lightning onboarding using shared UTXOs, timeout-signature trees, and Poon-Dryja channels. *By [@8144225309](https://github.com/8144225309)*
