...
- [ScoutQA Vibe Testing Skill](https://github.com/scoutqa-dot-ai/claude-code) - Run AI-powered exploratory tests on web applications using natural language prompts, ScoutQA automatically tests your websites for accessibility issues, broken user flows, and usability problems — all from simple English instructions.
