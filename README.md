...
- [TweetClaw](https://github.com/Xquik-dev/tweetclaw) - Post tweets, reply, like, retweet, follow, DM, search, extract data, run giveaways, and monitor accounts. 40+ X/Twitter endpoints via 2 tools. *By [@Xquik-dev](https://github.com/Xquik-dev)*
