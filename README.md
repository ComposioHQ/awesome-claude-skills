...
- [SkillCompass](https://github.com/Evol-ai/SkillCompass) - Local-first skill quality evaluator that scores skills across six dimensions, identifies the weakest one, suggests targeted fixes, and tracks quality over time. *By [@Evol-ai](https://github.com/Evol-ai)*
