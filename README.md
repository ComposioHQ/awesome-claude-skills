...
- [faf-cli](https://github.com/Wolfe-Jam/faf-cli) - Foundational AI-context format. Generates persistent project DNA (.faf files) that give any AI instant context. One command, any repo. IANA-registered, 36,000+ npm downloads. *By [@Wolfe-Jam](https://github.com/Wolfe-Jam)*
