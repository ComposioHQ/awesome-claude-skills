...
- [Signum](https://github.com/heurema/signum) - Evidence-driven development pipeline that audits AI-generated code with three independent models (Claude, Codex, Gemini), deduplicates findings, and bundles everything into a tamper-evident proofpack. *By [@netmin](https://github.com/netmin)*
