...
- [Claude Skills](https://github.com/borghei/Claude-Skills) - 245 production AI skills across 14 domains covering engineering, compliance (18 frameworks incl. ISO 13485, MDR, FDA, EU AI Act, NIS2, DORA, SOC 2, GDPR), C-suite advisory, marketing, legal and finance. One-command install across 11 AI assistants via `npx @borghei/claude-skills`. *By [@borghei](https://github.com/borghei)*
