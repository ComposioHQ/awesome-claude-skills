...
- [Metis Gateway](https://github.com/Kenny1338/claude-telegram-gateway) - Self-managing Telegram gateway for Claude that routes through `claude -p` (the CLI). Features persistent sessions, scheduled triggers, voice transcription (Whisper) and TTS (ElevenLabs), budget tracking, and a control API. Single Python file, systemd-ready. *By [@Kenny1338](https://github.com/Kenny1338)*
