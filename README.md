...
- [GhostClaw](https://github.com/b1rdmania/ghostclaw) - An AI agent that lives on your computer and works for you. Message it on Telegram like a co-worker. Built on Claude Code + Agent SDK. No containers, no cloud. [ghostclaw.io](https://ghostclaw.io) *By [@b1rdmania](https://github.com/b1rdmania)*
