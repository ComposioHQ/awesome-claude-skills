...
- [gdb-cli](./gdb-cli/) - GDB debugging assistant for AI agents to analyze core dumps, debug live processes, and investigate crashes with source code correlation. *By [@Cerdore](https://github.com/Cerdore)*
