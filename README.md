...
- [humanizer](https://github.com/Aboudjem/humanizer-skill) - Detects 43 AI writing patterns and rewrites text with human rhythm. 5 voice profiles, burstiness + perplexity science, 8 editor integrations, zero dependencies. *By [@Aboudjem](https://github.com/Aboudjem)*
