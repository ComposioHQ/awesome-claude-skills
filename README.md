...
- [Charles Proxy Extractor](https://github.com/wannabehero/charles-proxy-extract-skill) - Claude is able to extract and analyze HTTP traffic from Charles Proxy session files. *By [@wannabehero](https://github.com/wannabehero)*
