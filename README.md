...
- [Claude Code Minoan](https://github.com/tdimino/claude-code-minoan) - 60+ skills for local RAG (RLAMA + Ollama), cross-model visual dialogue (Gemini + Claude), neural web search (Exa), image generation (Gemini 3 Pro), SMS/Slack/email, LLM eval pipelines, Codex CLI orchestration with 10 profiles, multi-agent teams, and session management. Pairs with [Claudicle](https://github.com/tdimino/claudicle) for persistent soul identity across sessions. *By [@tdimino](https://github.com/tdimino)*
