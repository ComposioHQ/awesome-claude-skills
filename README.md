...
- [Crawlio](https://github.com/Crawlio-app/crawlio-plugin) - 5 skills + 1 agent for website crawling and auditing. Crawl sites, capture browser intelligence, run 4-pass audits, and produce evidence-backed findings. Install: `npx crawlio-mcp init`. *By [@rashidazarang](https://github.com/rashidazarang)*
