...
- [Rove](https://github.com/noncelogic/rove) - Hosted Playwright MCP server for AI agents. Returns accessibility trees instead of screenshots (77% fewer tokens), zero infrastructure. *By [@noncelogic](https://github.com/noncelogic)*
