...
- [Alpha Insights](https://github.com/Ericyoung-183/alpha-insights) - Professional business analysis skill with 19 frameworks, multi-source data triangulation, harness-enforced quality gates, and structured HTML report generation. *by @Ericyoung-183
