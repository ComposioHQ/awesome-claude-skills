...
- [Social Auto Engine](https://github.com/Freespirits/social-auto-engine) - MCP server and dashboard for multi-channel social media management. Publish to Facebook, Instagram, Threads, WhatsApp, and LinkedIn from one place; TikTok and YouTube adapters live in the codebase awaiting platform review. 17 AI content skills cover voice training, post writing, and carousel generation. An approval queue gates every send — no silent automation. *By [@Freespirits](https://github.com/Freespirits)*
