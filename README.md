...
- [Playwright QA Skills](https://github.com/sharmasundip/playwright-qa-skills) - Professional QA pipeline for Claude Code including auth setup, recording reviewer, and automated test healing. *By [@sharmasundip](https://github.com/sharmasundip)*
