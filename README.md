...
- [aluvia-cursor](https://github.com/aluvia-connect/aluvia-skills/tree/main/cursor-skill) - Unblock web requests using Aluvia mobile carrier proxies. Routes traffic through real US mobile IPs (AT&T, T-Mobile, Verizon) to bypass anti-bot systems, CAPTCHAs, and rate limits with automatic block detection.
