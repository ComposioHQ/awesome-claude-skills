...
- [Server-Side Swift & Xcode Cloud Skills](https://github.com/melissa-pereira-deel/claude-code-server-side-swift-skills) - 15 production-ready skills for server-side Swift (Vapor 4, Hummingbird 2, Fluent ORM, JWT auth, Docker deployment) and Xcode Cloud CI/CD (workflows, ci_scripts, TestFlight, App Store submission, troubleshooting). *By [@melissa-pereira-deel](https://github.com/melissa-pereira-deel)*
