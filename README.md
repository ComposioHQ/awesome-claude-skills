...
- [ctx-bundles](https://github.com/puretensor/ctx-bundles) - Deep context bundles that give Claude Code instant operational knowledge for 14 popular stacks (NestJS, FastAPI, PostgreSQL, Next.js, Kubernetes, etc.) with architecture patterns, correct idioms, and real failure modes. *By [PureTensor, Inc.](https://github.com/puretensor)*
