...
- [Claude Ecom](./claude-ecom/) - Turns order or sales CSV data into ecommerce business reviews with KPI decomposition, prioritized findings, and concrete next actions. By [@takechanman1228](https://github.com/takechanman1228).
