...
- [Global Chat MCP Server](https://github.com/pumanitro/global-chat) - Cross-protocol AI agent discovery via MCP. Search 18K+ agents across MCP, A2A, and agents.txt registries, validate agents.txt files, and register new agents. *By [@pumanitro](https://github.com/pumanitro)*
