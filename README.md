...
- [claude-skills](https://github.com/jezweb/claude-skills) - 99 production-ready skills covering Cloudflare Workers, AI/LLM integrations, React/Tailwind, auth, databases, and more. Includes 39 specialized agents and documented error prevention patterns. *By [@jezweb](https://github.com/jezweb)*
