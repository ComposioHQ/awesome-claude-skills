...
- [skill-doctor](https://github.com/LpcPaul/skill-doctor) - AI agent skill ER — diagnoses skill failures, conflicts, and mis-selection with community case database and privacy-first redaction. *By [@LpcPaul](https://github.com/LpcPaul)*
