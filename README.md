...
- [create-viral-content](https://github.com/aaaronmiller/create-viral-content) - Transforms any topic into viral social content across Reddit, Twitter/X, LinkedIn, YouTube, TikTok, and Instagram Reels. Includes hook architecture, AI tell detection, platform-specific templates, deliberative refinement protocol, and 40-source research basis for titles and thumbnails. *By [@aaaronmiller](https://github.com/aaaronmiller)*
