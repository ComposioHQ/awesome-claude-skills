...
- [MCP Tool Developer](https://github.com/demo112/yunqu-ai-skills/tree/main/10-mcp-tool-developer) - Full-stack MCP server development with TypeScript/Python. Covers specification, implementation, testing, deployment, and registry publishing. Complements MCP Builder with deeper tool design patterns. *By [@yundu-ai](https://github.com/demo112)*
...
- [Xiaohongshu Content Strategist](https://github.com/demo112/yunqu-ai-skills/tree/main/08-xiaohongshu-content-strategist) - Create viral Xiaohongshu (小红书) content with save-rate optimization, trending formats, and search SEO for China's #1 lifestyle platform. Zero-competition Chinese market skill. *By [@yundu-ai](https://github.com/demo112)*
- [WeChat Official Account Strategist](https://github.com/demo112/yunqu-ai-skills/tree/main/14-wechat-official-account-strategist) - Grow WeChat Official Accounts (微信公众号) with high-conversion content strategy, title formulas, article architecture, and Mini-Program integration. *By [@yundu-ai](https://github.com/demo112)*
- [Chinese Market Content Engineer](https://github.com/demo112/yunqu-ai-skills/tree/main/04-chinese-market-content-engineer) - Multi-platform Chinese content strategy for 知乎, 抖音, B站 with bilingual creation, cultural sensitivity, and compliance. *By [@yundu-ai](https://github.com/demo112)*
