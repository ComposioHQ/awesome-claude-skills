...
- [ShipPage](https://github.com/jieshu666/ShipPage-Skill) - Zero-config HTML publishing for AI agents. One HTTP POST turns any HTML or Markdown into a public URL at shippage.ai/p/{slug}. Auto-registers on first call — no account, no API keys. *By [@jieshu666](https://github.com/jieshu666)*
