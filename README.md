...
- [master-skill](https://github.com/voidborne-d/master-skill) - Distill any sub-niche industry into a runnable Master OS skill. Input an industry → 6-track research (figures/tools/workflows/canon/sources/glossary) → installable skill with mental models, decision rules, CLI scripts, and per-figure sub-skills. Includes 7 example industries. *By [@voidborne-d](https://github.com/voidborne-d)*
