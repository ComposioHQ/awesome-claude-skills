...
- [Teenybase](./teenybase/) - Set up and manage Teenybase backends -- a TypeScript-configured backend framework on Cloudflare Workers + D1 that generates CRUD endpoints, auth, row-level security, migrations, OpenAPI docs, and an admin panel from a single config file.
