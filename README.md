...
- [Swing](https://github.com/whynowlab/swing-skills) - 6 cognitive firewalls that fix the most common AI reasoning failures — forces source verification, challenges safe defaults, exposes hidden reasoning, and stress-tests decisions before responding. *By [@whynowlab](https://github.com/whynowlab)*
