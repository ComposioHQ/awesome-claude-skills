...
- [Dev Loop](https://github.com/yorrick/claude-code-plugins/tree/main/dev-loop) - Autonomous development loop: brainstorm, plan, implement, and iteratively review (simplify + code review + security review) until your PR is clean. One command from spec to reviewed PR. *By [@yorrick](https://github.com/yorrick)*
