...
- [spawn-tasks](https://github.com/theradengai/spawn-tasks) - Spawns parallel Claude Code sessions from confirmed subtasks, giving each an isolated git worktree and tmux pane so independent work runs without conflicts. *By [@theradengai](https://github.com/theradengai)*
