...
- [Hashnet MCP](https://github.com/hashgraph-online/hashnet-mcp) - MCP server for AI agent discovery via Registry Broker, aggregating agents from NANDA, MCP, Virtuals, A2A, and ERC-8004 registries. *By [@hashgraph-online](https://github.com/hashgraph-online)*
