...
- [claude-code-notify](https://github.com/JadenChoi2k/claude-code-notify) - Zero-dependency desktop notification system using native OS notifications (macOS/Linux) via shell-based hooks with clickable alerts and notification grouping. *By [@JadenChoi2k](https://github.com/JadenChoi2k)*
