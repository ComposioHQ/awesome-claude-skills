...
- [AiDex](https://github.com/CSCSoftware/AiDex) - Persistent code index MCP server using Tree-sitter. Fast, precise code search with ~50 tokens instead of 2000+ via grep. Supports 11 languages.
