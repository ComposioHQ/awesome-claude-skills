...
- [Open-Source Pipeline](./opensource-pipeline/) - Safely open-source any private project through a 3-stage pipeline: fork (strip secrets), sanitize (verify clean), and package (CLAUDE.md, setup.sh, README, LICENSE). Inspired by [herakles-dev/opensource-pipeline](https://github.com/herakles-dev/opensource-pipeline).
