...
- [Karpathy Guidelines](https://github.com/swarmclawai/andrej-karpathy-skills) - Behavioral coding-agent guidelines derived from Andrej Karpathy's LLM coding pitfalls, packaged for Claude Code, Codex, Cursor, Gemini CLI, OpenCode, OpenClaw, and other Agent Skills-compatible tools. *By [@swarmclawai](https://github.com/swarmclawai)*
