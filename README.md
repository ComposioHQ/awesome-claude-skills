...
- [faf-cli](https://github.com/Wolfe-Jam/faf-cli) - Generates persistent project context files (.faf format) that give AI assistants instant codebase understanding. *By [@Wolfe-Jam](https://github.com/Wolfe-Jam)*
