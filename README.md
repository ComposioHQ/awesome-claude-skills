...
- [Claude Code Minoan](https://github.com/tdimino/claude-code-minoan) - 60+ skills for local RAG (RLAMA + Ollama), cross-model visual dialogue (Gemini + Claude), image generation (Gemini 3 Pro), SMS/Slack/email, LLM eval pipelines, Codex CLI orchestration with 10 profiles, multi-agent teams, and session management. *By [@tdimino](https://github.com/tdimino)*
