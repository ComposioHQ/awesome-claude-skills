...
- [api-lazy-tester](https://github.com/NissonCX/api-lazy-tester) - AI-powered API testing workflow for Claude Code and Codex. Automatically discovers APIs via git diff, generates test cases, and executes tests.
