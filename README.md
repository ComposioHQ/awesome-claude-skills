...
- [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) - X (Twitter) data extraction & automation skill for AI coding agents. 40+ tools covering tweet search, user lookup, follower extraction, engagement metrics, giveaway draws, trending topics, write actions, and Telegram integrations. *By [@kriptoburak](https://github.com/kriptoburak)*
