...
- [claudecheck](https://github.com/lunacompsia-oss/claudecheck) - Lint and validate your CLAUDE.md files. Zero dependencies. CLI + GitHub Action. 12 rules for structure, secrets, placeholders. *By [@lunacompsia-oss](https://github.com/lunacompsia-oss)*
