...
- [deep-context](https://github.com/googlarz/deep-context) - Builds verified, comprehensive context packs from a folder — citations, contradiction detection between docs, self-test calibration, and a one-page actionable digest. *By [@googlarz](https://github.com/googlarz)*
- [deterministic-workflow-builder](https://github.com/googlarz/deterministic-workflow-builder) - Deterministic, auditable workflow execution for Claude and Codex — typed manifests, approval gates, audit trails, and live HTML visualization. *By [@googlarz](https://github.com/googlarz)*
...
- [logic-audit](https://github.com/googlarz/logic-audit) - Adversarial cross-artifact logic and consistency audit — finds contradictions, unstated assumptions, and logical gaps across specs, ADRs, code, and PRDs before they ship. *By [@googlarz](https://github.com/googlarz)*
...
- [math-skill](https://github.com/googlarz/math-skill) - Rigorously solves math problems — equations, proofs, optimization, geometry — with step-by-step reasoning and built-in verification. *By [@googlarz](https://github.com/googlarz)*
...
- [betriebsrat](https://github.com/googlarz/betriebsrat) - German labour law for employees and works council members — grounded in gesetze-im-internet.de and the complete BetrVG, fully offline, in German or English. *By [@googlarz](https://github.com/googlarz)*
...
- [finance-assistant](https://github.com/googlarz/finance-assistant) - Personal finance copilot for Claude Code — budgets, bank import (CSV/MT940/OFX), debt optimizer, investments, taxes, multi-currency, encrypted at rest. Country-specific locale packs for DE, UK, FR, NL, PL. *By [@googlarz](https://github.com/googlarz)*
...
- [fashion-skill](https://github.com/googlarz/fashion-skill) - Personal AI stylist for Claude Code — wardrobe inventory, outfit recommendations, gap analysis ("what am I missing?"), pre-purchase checks, and in-store mode. *By [@googlarz](https://github.com/googlarz)*
