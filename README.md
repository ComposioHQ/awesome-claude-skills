...
- [Olostep Web Research](https://docs.olostep.com/features/skills) - Search the web, scrape URLs to clean Markdown, and get AI-powered research answers using the Olostep API. Covers web search (`/searches`), URL scraping (`/scrapes`), and AI answers via the Python SDK.
