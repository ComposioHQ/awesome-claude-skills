...
- [Project Ledger](https://github.com/SethDrew/project-ledger) - Structured memory system for Claude Code that logs findings to a YAML ledger with TF-IDF search injection on every prompt. *By [@SethDrew](https://github.com/SethDrew)*
