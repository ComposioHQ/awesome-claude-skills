...
- [coding-skills](https://github.com/swell-agents/coding-skills) - Ten canonical Anthropic Agent Skills for software engineering — running-tdd-cycles, reviewing-changes, designing-architecture, managing-github-issues, committing-changes, plus per-language conventions for Python, Go, Solidity, shell, and engineering-philosophy. *By [@swell-agents](https://github.com/swell-agents)*
