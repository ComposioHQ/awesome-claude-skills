...
- [fp-ts-errors](./fp-ts-errors/) - Type-safe error handling with fp-ts Either and TaskEither for cleaner TypeScript code. *By [@whatiskadudoing](https://github.com/whatiskadudoing)*
- [fp-ts-pragmatic](./fp-ts-pragmatic/) - The 80/20 of functional programming with fp-ts - practical patterns without academic jargon. *By [@whatiskadudoing](https://github.com/whatiskadudoing)*
- [fp-ts-react](./fp-ts-react/) - Patterns for using fp-ts with React 18/19 and Next.js - state, forms, and data fetching. *By [@whatiskadudoing](https://github.com/whatiskadudoing)*
