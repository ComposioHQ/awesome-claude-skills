...
- [Reporecall](https://github.com/proofofwork-agency/reporecall) - Local codebase memory for Claude Code. Pre-indexes with Tree-sitter AST (22 languages), builds call graphs, and injects relevant context via hooks in ~5ms. Reduces token usage by 3-8x. Also works as an MCP server.
