...
- [haruspex-skills](https://github.com/Haruspex-guru/haruspex-skills) - Collection of four Anthropic Agent Skills for stock traders powered by the Haruspex API: single-ticker analysis, watchlist review, thesis tracking, and a Japanese-language flagship variant. Analysis-only with compliance disclaimer; depends on [`@haruspex-guru/mcp-server`](https://www.npmjs.com/package/@haruspex-guru/mcp-server). *By [@Haruspex-guru](https://github.com/Haruspex-guru)*
