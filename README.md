...
- [rcl-score](https://github.com/ZhenyuanPAN822/rcl-score-skill) - Turn a two-person chat (WeChat CSV / JSON / TXT) into a relationship K-line candlestick chart. The IDE LLM scores every turn with v3.1 semantic deltas across 10 dimensions; a local web frontend renders OHLC + MA / BB / MACD / RSI / KDJ with per-bar attribution. Everything runs locally — chat data never leaves the machine. Bilingual (EN+中文). *By [@ZhenyuanPAN822](https://github.com/ZhenyuanPAN822)*
