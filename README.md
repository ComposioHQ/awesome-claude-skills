...
- [hyprland](./hyprland/) - Control the Hyprland Wayland desktop and interact with any running application — click buttons, type text, take screenshots, manage windows, and automate GUI workflows on Linux. *By [@junjieit](https://github.com/junjieit)*
