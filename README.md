...
- [Scaffold Framework](https://github.com/alexxenn/scaffold) - 17-skill framework with persistent Obsidian memory, multi-agent decision enforcement, and ~75% token savings via 3-tier model routing. Sessions resume instead of restart. *By [@alexxenn](https://github.com/alexxenn)*
