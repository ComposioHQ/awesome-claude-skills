...
- [KubeStellar Console](https://github.com/kubestellar/console) - Multi-cluster Kubernetes operations skill with AI-powered dashboards, MCP server integration (kc-agent), and knowledge of 20+ CNCF projects for edge-to-cloud cluster management. *By [@clubanderson](https://github.com/clubanderson)*
