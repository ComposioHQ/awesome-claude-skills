...
- [Design Principles](./design-principles/) - Enforce precise, minimal design system inspired by Linear, Notion, and Stripe for dashboards, admin interfaces, and enterprise UI with Jony Ive-level craft.
