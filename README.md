...
- [oiloil-ui-ux-guide](https://github.com/oil-oil/oiloil-ui-ux-guide) - Modern UI/UX guidance and review skill with two modes: `guide` for actionable do/don't rules, and `review` for prioritized P0/P1/P2 fix lists. Covers CRAP, task-first UX, cognitive load, HCI laws (Fitts/Hick/Miller), and interaction psychology. *By [@oil-oil](https://github.com/oil-oil)*
