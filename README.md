...
- [AI Employee Skills](https://github.com/iamKhan79690/claude-skills-collection) - Autonomous business automation suite with 8 production-ready skills for front-office and back-office operations. Includes social media management (Facebook, Instagram, Threads, WhatsApp, LinkedIn), Odoo ERP accounting, CEO intelligence briefings, task workflow automation, GitHub operations, and system monitoring. *By [@iamKhan79690](https://github.com/iamKhan79690)*
