...
- [CLI-Anything-Web](https://github.com/ItamarZand88/CLI-Anything-WEB) - Generate production-grade Python CLIs for any web app by capturing HTTP traffic. Plugin with 4-phase pipeline: capture → analyze → generate → test. Ships with 10 reference CLIs (Reddit, Booking.com, Google Stitch, Pexels, and more). *By [@ItamarZand88](https://github.com/ItamarZand88)*
