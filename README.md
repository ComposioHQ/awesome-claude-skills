...
- [Playwright Skill](https://github.com/testdino-hq/playwright-skill) - Production-ready Playwright skill for AI agents. Includes structured SKILL.md, automation patterns, and MCP-ready configurations for scalable test generation and reporting.
