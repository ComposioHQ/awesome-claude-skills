...
- [NoizAI Skills](https://github.com/NoizAI/skills) - Human-like TTS workflow skills with local/cloud backends, style presets, and app-delivery-oriented voice scripts.
