...
- [BodAIGuard](https://github.com/BodAIGuard/BodAIGuard) - AI agent guardrail that integrates with Claude Code hooks to monitor and control agent actions, preventing unsafe operations in real time.
