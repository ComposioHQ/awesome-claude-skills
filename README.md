...
- [cc-toolkit](https://github.com/yurukusa/cc-toolkit) - 35+ zero-dependency CLI tools for Claude Code — analytics, safety auditing, cost forecasting, reporting, and more. All tools run instantly with npx, no config needed. *By [@yurukusa](https://github.com/yurukusa)*
