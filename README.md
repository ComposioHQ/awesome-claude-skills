...
- [Playwright Browser Automation](https://github.com/lackeyjb/playwright-skill) - Model-invoked Playwright automation for testing and validating web applications. *By [@lackeyjb](https://github.com/lackeyjb)*
  - [productionize](https://github.com/G26karthik/skill-productionize) - Transform any codebase into production-grade code with documentation, error handling, input validation, type safety, structured logging, security hardening, naming clarity, magic value extraction, and contributor comments. By [@G26karthik](https://github.com/G26karthik)
