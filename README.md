...
- [multi-archetype-audit](./multi-archetype-audit/) - Comprehensive code audit using 7 specialized archetypes (API, Performance, Warnings, DRY, Complexity, Robustness, Build) for multi-perspective code quality analysis. *By [@sebaboubou-max](https://github.com/sebaboubou-max)*
