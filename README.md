...
- [Coware](https://github.com/shitianfang/coware-skills) - Sync shared API specs across AI coding agents. Prevents merge conflicts in multi-dev teams. *By [@shitianfang](https://github.com/shitianfang)*
