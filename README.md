...
- [Social Auto Engine](https://github.com/Freespirits/social-auto-engine) - MCP server and dashboard for multi-channel social media management. Publish to Facebook, Instagram, WhatsApp, and Threads from Claude Code with an approval queue, scheduling, and analytics. *By [@Freespirits](https://github.com/Freespirits)*
