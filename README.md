...
- [Secrets Security Scanner](./secrets-security-scanner/) - Scan codebases for hardcoded secrets, API keys, and environment vulnerabilities. Detects leaked credentials and provides secure migration strategies to secret managers.
