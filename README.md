...
- [ProxyGate](https://github.com/proxygate-official/proxygate) - API marketplace for AI agents — buy and sell API capacity with USDC on Solana. 6 skills (pg-setup, pg-buy, pg-sell, pg-jobs, pg-status, pg-update) for the full buyer/seller/jobs lifecycle. Install: `npx skills add proxygate-official/proxygate`. *By [@proxygate-official](https://github.com/proxygate-official)*
