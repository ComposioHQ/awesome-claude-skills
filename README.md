...
- [chat-manager](https://github.com/HongjieRen/claude-skill-chat-manager) - List, inspect, delete, and get smart cleanup suggestions for Claude Code conversation history stored in ~/.claude/projects/. *By [@HongjieRen](https://github.com/HongjieRen)*
