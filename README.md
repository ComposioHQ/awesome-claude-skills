...
- [resemble-detect](https://github.com/resemble-ai/detect-skill) - Deepfake detection for audio, image, video, and text via the [Resemble AI](https://resemble.ai) platform. Includes audio source tracing, watermarking, and identity verification.
