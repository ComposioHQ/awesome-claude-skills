...
- [fcontext Context Continuity](https://github.com/lijma/agent-skill-fcontext) - Maintain context continuity across AI agent sessions and tools. Persist session knowledge, track requirements, index binary documents, and share domain expertise via experience packs. *By [@lijma](https://github.com/lijma)*
