...
- [faf-skills](https://github.com/Wolfe-Jam/faf-skills) - 31 Claude Code skills for persistent project context (.faf, `application/vnd.faf+yaml`). Anthropic MCP #2759. *By [@Wolfe-Jam](https://github.com/Wolfe-Jam)*
