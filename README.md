...
- [SidClaw](https://github.com/sidclawhq/platform) - AI agent governance with approval workflows, policy engine, hash-chain audit trails, and 18+ framework integrations. Apache 2.0. *By [@sidclawhq](https://github.com/sidclawhq)*
