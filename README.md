...
- [review-loop](https://github.com/NYTC69/review-loop) - Automates Plan-Execute-Review loops with cross-AI code review using an independent Reviewer (e.g. OpenAI Codex CLI) to catch blind spots. *By [@NYTC69](https://github.com/NYTC69)*
