...
- [claude-persona](https://github.com/takechanman1228/claude-persona) - Build AI persona panels and pressure-test product concepts before paying for fieldwork. Generates diverse personas with Big Five traits, runs agent-separated concept tests (each persona as an independent subprocess), and produces an executive report with theme synthesis, cross-tabs, and verbatims. *By [@takechanman1228](https://github.com/takechanman1228)*
