...
- [steel-browser](./steel-browser/) - Session-backed browser automation for navigation, extraction, screenshots, PDFs, and multi-step web workflows. Credit: based on Steel's browser automation workflow.
