...
- [Claude Usage Analyzer](https://github.com/SingggggYee/claude-usage-analyzer) - Analyzes Claude Code token usage from local session logs. Shows where tokens went, which projects cost most, and how to reduce waste. *By [@SingggggYee](https://github.com/SingggggYee)*
