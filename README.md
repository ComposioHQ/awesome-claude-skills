...
- [Metaskill](https://github.com/xvirobotics/metaskill) - A meta-skill suite for generating complete AI agent teams. Includes /metaskill (full team generator), /create-agent (single agent builder), and /create-skill (single skill builder) with a 4-phase workflow producing .claude/ directories with agents, skills, rules, and MCP configs. *By [@xvirobotics](https://github.com/xvirobotics)*
