...
- [newsmcp](https://github.com/CuriouslyCory/newsmcp) - MCP server and Claude Code skill for real-time world news briefings covering 50+ regions. Provides AI agents with current events context via topic and region filtering. *By [@CuriouslyCory](https://github.com/CuriouslyCory)*- [MCP Builder](./mcp-builder/) - Guides creation of high-quality MCP (Model Context Protocol) servers for integrating external APIs and services with LLMs using Python or TypeScript.
