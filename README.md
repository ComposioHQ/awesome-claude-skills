...
- [Claude Skins](https://github.com/basicScandal/claude-skins) - 9 custom visual themes with terminal colors, ASCII art banners, personality voices, status lines, and tool sounds. Includes /skin slash command skill. [Gallery](https://basicscandal.github.io/claude-skins/). *By [@basicScandal](https://github.com/basicScandal)*
