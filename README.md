...
- [preflight](https://github.com/preflight-dev/preflight) - 24-tool MCP server that scores prompts before execution, catches ambiguity and missing context, tracks correction patterns, and estimates token cost — reduces 30-40% wasted tokens from vague prompt → wrong output → fix cycles. *By [@TerminalGravity](https://github.com/TerminalGravity)*
