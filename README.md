...
- [fresh-eyes-review](https://github.com/2389-research/fresh-eyes-review) - Mandatory pre-commit sanity check that catches security vulnerabilities, logic errors, and business rule bugs that slip through despite passing tests. *By [@2389-research](https://github.com/2389-research)*
...
- [review-squad](https://github.com/2389-research/review-squad) - Dispatches parallel panels of specialized reviewer subagents for multi-perspective project audits, including expert panels, first-impression personas, and task-completion flows. *By [@2389-research](https://github.com/2389-research)*
- [simmer](https://github.com/2389-research/simmer) - Iterative artifact refinement with investigation-first judges that read the code, understand the problem, and propose evidence-based improvements over multiple rounds. *By [@2389-research](https://github.com/2389-research)*
