...
- [SpecLock](https://github.com/sgroy10/speclock) - AI Constraint Engine that enforces AI rule files as laws. 51 MCP tools, semantic conflict detection, pre-commit hooks. *By [@sgroy10](https://github.com/sgroy10)*
