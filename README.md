...
- [Entroly](https://github.com/juyterman1000/entroly) - Open-source context optimization engine that cuts AI API costs by 70-95% using submodular knapsack selection and PRISM reinforcement learning. Features semantic caching and SimHash deduplication.
