...
- [agent-os-governance](https://github.com/microsoft/agent-governance-toolkit) - Kernel-level governance for AI agents — deterministic policy enforcement, compliance checking (SOC2/GDPR/HIPAA), and audit logging. Featured in [awesome-llm-apps](https://github.com/Shubhamsaboo/awesome-llm-apps) (92k ⭐). *By [@imran-siddique](https://github.com/imran-siddique)*
