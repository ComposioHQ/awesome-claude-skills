...
- [PactKit](https://github.com/pactkit/pactkit-public) - Spec-driven PDCA governance framework with 9 agents, 21 skills, and strict TDD. Deploys Plan-Act-Check-Done workflows as skills for Claude Code, OpenCode, and Codex CLI. *By [@pactkit](https://github.com/pactkit)*
