...
- [XVARY Stock Research](./xvary-stock-research/) - Thesis-driven equity analysis from public SEC EDGAR and market data with conviction scoring, kill criteria, and `/analyze`, `/score`, `/compare` workflows. *By [XVARY Research](https://xvary.com)*
