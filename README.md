...
- [Schliff](https://github.com/Zandereins/schliff) - Deterministic quality scorer for AI instruction files (CLAUDE.md, SKILL.md, .cursorrules, AGENTS.md). Scores 7 weighted dimensions with no LLM in the scoring path, returns ranked fixes with estimated point impact, and gates CI via `schliff verify --regression`. *By [@Zandereins](https://github.com/Zandereins)*
