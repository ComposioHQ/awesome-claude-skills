...
- [pumpclaw](https://github.com/chainstacklabs/pumpclaw) - Agent skill for pump.fun token trading on Solana. Buy, sell, launch tokens, manage wallets, dry-run simulation, slippage checks, and PumpSwap AMM migrations via pumpfun-cli. *By [@chainstacklabs](https://github.com/chainstacklabs)*
