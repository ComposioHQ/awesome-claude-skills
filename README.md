...
- [kicad-happy](https://github.com/aklofas/kicad-happy) - AI-powered design review for KiCad electronics. Analyzes schematics, PCB layouts, and Gerbers — catches bugs before you order boards. Includes EMC pre-compliance, SPICE simulation, datasheet verification, BOM sourcing, and engineering documentation. *By [@aklofas](https://github.com/aklofas)*
