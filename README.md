...
- [OpenPaw](https://github.com/daxaur/openpaw) - Open-source CLI tool (`npx pawmode`) that turns Claude Code into a personal assistant with 38 built-in skills including Telegram, Discord, Obsidian memory, daily briefings, and more. No daemon, no cloud, MIT licensed. *By [@daxaur](https://github.com/daxaur)*
