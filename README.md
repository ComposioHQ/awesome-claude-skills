...
- [Gorilla Lead Finder](./gorilla-lead-finder/) - Find your first SaaS users by searching Reddit, X, YouTube, and TikTok for posts where people describe a problem your product solves. Ranks each by buying intent and drafts platform-tuned outreach. Backed by [usegorilla.app](https://usegorilla.app).
