...
- [showdown](https://github.com/vanderheijden86/showdown-claude-skill) - Multi-model LLM comparison skill that sends identical prompts to Claude, ChatGPT, and Gemini in parallel, then enables blind cross-judging where each model scores the others. Exports structured markdown reports. *By [@vanderheijden86](https://github.com/vanderheijden86)*
