...
- [Origin](https://github.com/7xuanlu/origin/tree/main/plugin) - Claude Code plugin for local AI-work memory: brief, capture, recall, handoff, and distill, backed by a local daemon and MCP so context carries across sessions. *By [@7xuanlu](https://github.com/7xuanlu)*
