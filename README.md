...
- [Project Memory Manager](./project-memory-manager/) - Manages persistent project memory for AI coding agents with isolated workspaces per project and a web dashboard for reviewing agent memory. Powered by [MemClaw](https://memclaw.me).
