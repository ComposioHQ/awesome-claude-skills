...
- [EvalView](https://github.com/hidai25/eval-view) - Regression testing for AI agents. Snapshots tool calls, parameters, and output, then diffs against baselines to catch silent regressions. Includes MCP server, CI/CD integration, and multi-turn test support. *By [@hidai25](https://github.com/hidai25)*
