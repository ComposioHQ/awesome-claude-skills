...
- [KANBAII](https://github.com/martinmsaavedra/kanbaii) - AI-native kanban board for Claude Code — plan visually, track progress, let AI execute. Includes sequential engine, parallel multi-agent teams, cost tracking, and a real-time dashboard. `npx kanbaii start` *By [@martinmsaavedra](https://github.com/martinmsaavedra)*
