...
- [Den](https://github.com/us/den) - Self-hosted sandbox runtime for AI agents with secure isolated containers, built-in MCP server, and code execution support. Open-source E2B alternative. *By [@us](https://github.com/us)*
