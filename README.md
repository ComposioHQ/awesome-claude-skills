...
- [SEO Keyword Research](https://github.com/yoyothesheep/claude-skills/tree/main/seo-keyword-research) - Use to understand competitor SEO tactics, find keyword opportunities, identify content gaps, or build a keyword strategy based on competitive intelligence.
- [AEO Topic Research](https://github.com/yoyothesheep/claude-skills/tree/main/aeo-topic-research) - Identifies what to create for AEO, and how to present it, by discovering what questions AI engines are answering in your niche, which domains and pages they're citing, and what content formats are winning citations.
