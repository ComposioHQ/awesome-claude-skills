...
- [BodAIGuard](https://github.com/AxonLabsDev/BodAIGuard) - AI agent guardrail that integrates with Claude Code hooks to monitor and control agent actions, preventing unsafe operations in real time.
