...
- [Vaultweaver](https://github.com/Apexlify/vaultweaver) - LLM Knowledge Base compiler that ingests raw sources into interconnected Obsidian-compatible markdown wikis with auto-ingest, BM25 search, and drift detection.
