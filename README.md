...
- [crw](https://github.com/us/crw) - MCP server that gives Claude web scraping superpowers: crawl, scrape, and map websites. Install: `cargo install crw-mcp && claude mcp add crw -- crw-mcp`. *By [@us](https://github.com/us)*
