...
- [claude-debug](https://github.com/krabat-l/claude-debug) - Phase-gated debugging methodology. PreToolUse hooks block code edits until the agent has reproduced the bug, isolated it with diagnostics, and confirmed the root cause. Includes 6 bug-type strategies, 3 read-only agents, and zero-install option. *By [@krabat-l](https://github.com/krabat-l)*
