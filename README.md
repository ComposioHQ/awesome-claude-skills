...
- [Syntropic](https://github.com/petercholford-ship-it/syntropic-cli) - Scaffolds a development methodology into AI coding tool instruction files (CLAUDE.md, .cursorrules, .windsurfrules, copilot-instructions.md) with 9 Evergreen Rules, 6 agents, and a health check GitHub Action. *By [@petercholford-ship-it](https://github.com/petercholford-ship-it)*
