...
- [AgentMail](https://github.com/uriva/agentmail-skills) - Email for AI agents. Create email accounts, send/receive email, sign up for services, get verification codes, and manage webhooks with a REST API and karma-based spam prevention. *By [@uriva](https://github.com/uriva)*
