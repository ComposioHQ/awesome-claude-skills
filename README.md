...
- [security-scanning](https://github.com/sinewaveai/agent-security-scanner-mcp) - Scan code for SQL injection, XSS, secrets exposure, prompt injection, and hallucinated packages. *By [@sinewaveai](https://github.com/sinewaveai)*
