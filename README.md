...
- [Helium MCP](https://github.com/connerlambden/helium-mcp) - MCP server that gives Claude real-time access to news intelligence (3.2M+ articles with bias scoring), financial market data, ML options pricing, and meme search. Add to your MCP config: `{"type": "streamable-http", "url": "https://heliumtrades.com/mcp"}`. *By [@connerlambden](https://github.com/connerlambden)*
