...
- [Agent Forge](https://github.com/WeberG619/agent-forge) - Production-grade agent framework for Claude Code with 17 sub-agents, persistent memory, 22 slash commands, desktop automation, and common sense engine. *By [@WeberG619](https://github.com/WeberG619)*
