...
- [Progressive Estimation](./progressive-estimation/) - Estimate AI-assisted and hybrid development work with research-backed PERT statistics and calibration. By [Enreign](https://github.com/Enreign).
