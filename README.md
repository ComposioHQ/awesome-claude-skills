...
- [Claudebase](https://github.com/rohithzr/claudebase) - Back up, restore, and sync your Claude Code config (settings, skills, agents, hooks, rules, memory, MCP) to a private GitHub repo with named profiles, secret scanning, and multi-machine conflict detection. *By [@rohithzr](https://github.com/rohithzr)*
