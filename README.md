...
- [cc-token-status](https://github.com/jayson-jia-dev/cc-token-status) - macOS menu bar dashboard for Claude Code usage. Shows live plan limits (5h/7d), API-equivalent costs, model breakdown, multi-machine iCloud sync, and user level system. Single Python file via SwiftBar, 5 languages, auto-updates. *By [@jayson-jia-dev](https://github.com/jayson-jia-dev)*
