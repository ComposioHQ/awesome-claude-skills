...
- [EchoCoding](https://github.com/launsion-boop/EchoCoding) - Voice-enabled audio layer with hook-triggered SFX, ambient soundscapes, and cloud TTS/ASR `say`/`ask`/`listen` pipes for coding agents. Supports Claude Code, Cursor, Windsurf, Codex CLI, and Gemini CLI. *By [@launsion-boop](https://github.com/launsion-boop)*
