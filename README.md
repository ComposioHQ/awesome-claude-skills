...
- [SoulPass](https://github.com/soulpassai/soulpass-skill) - Hardware-secured Solana trading terminal for AI agents — Jupiter DEX swaps, meme coin trading with rug-pull detection, DeFi yield, automated trading bots. Keys in Apple Secure Enclave. *By [@soulpassai](https://github.com/soulpassai)*
