...
- [philidor](./philidor/) - DeFi vault intelligence with risk scores, yield comparison, portfolio analysis, and oracle monitoring across Morpho, Yearn, Aave, Beefy, and Spark. *By [@zkoranges](https://github.com/zkoranges)*
