...
- [semantic-commit-helper](https://github.com/tsubasaogawa/semantic-commit-helper) - Analyzes the staged diff, ask for the user's intent, and generate a Conventional Commit message before committing.
