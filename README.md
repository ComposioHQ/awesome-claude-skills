...
- [ESP32-AI-Agent-Skill](https://github.com/ezrover/ESP32-AI-Agent-Skill) - ESP32 embedded systems with chip selection, GPIO pin validation, Arduino/ESP-IDF code generation, LVGL UI references, and Waveshare board pinouts. *By [@ezrover](https://github.com/ezrover)*
