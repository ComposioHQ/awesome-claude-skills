...
- [humanize-chinese](https://github.com/voidborne-d/humanize-chinese) - Detect and humanize AI-generated Chinese text. 20+ detection categories, weighted 0-100 scoring, 7 style transforms, academic AIGC reduction (CNKI/VIP/Wanfang). Pure Python, zero dependencies.
