...
- [SwarmClaw](https://github.com/swarmclawai/swarmclaw/blob/main/skills/swarmclaw.md) - Self-hosted runtime for autonomous AI agents. Multi-provider, MCP-native, with memory, runtime skills, delegation, schedules, and reviewed conversation-to-skill learning across OpenClaw gateways and other providers. The skill teaches the agent when and how to interact with a running SwarmClaw instance. *By [@swarmclawai](https://github.com/swarmclawai)*
