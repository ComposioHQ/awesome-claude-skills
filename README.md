...
- [imessage-sms-agent](https://github.com/emotion-machine-org/imessage-no-mac-sms) - Give any AI agent iMessage, RCS & SMS capabilities. No Mac required. Works with Claude Code, Codex, Cursor, Gemini CLI. Powered by Claw Messenger ($5/mo). Install: `npx skills add emotion-machine-org/imessage-no-mac-sms` *By [@emotion-machine-org](https://github.com/emotion-machine-org)*
