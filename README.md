...
- [claude-learn](https://github.com/OutcomeFocusAi/claude-learn) - Self-improving behavioral rules plugin for Claude Code with scored rules, automated decay, and collective intelligence via community playbook sharing.
