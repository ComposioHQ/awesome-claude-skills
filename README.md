...
- [omega-memory](https://github.com/omega-memory/omega-memory) - Persistent memory MCP server for AI coding agents with semantic search, auto-capture, intelligent forgetting, and cross-session learning. Local-first with zero cloud dependency. *By [@omega-memory](https://github.com/omega-memory)*
