...
- [mermaid-design](https://github.com/iamvaleriofantozzi/mermaid-design) - Create editorial-quality diagrams using Mermaid.js syntax. Eleven diagram types with an opinionated design system, complexity budget, and taste gate. *By [@iamvaleriofantozzi](https://github.com/iamvaleriofantozzi)*
