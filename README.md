...
- [SwarmVault](https://github.com/swarmclawai/swarmvault) - Local-first RAG knowledge base compiler that turns raw docs, research, and code into a persistent markdown wiki, knowledge graph, and hybrid SQLite FTS + embeddings search. Ships a bundled skill and MCP server; works with Claude Code, Codex, and OpenCode. *By [@waydelyle](https://github.com/waydelyle)*
