...
- [trustboost-pii-sanitizer](https://github.com/teodorofodocrispin-cmyk/TrustBoost-PII-Sanitizer) - Blockchain-verified PII sanitization for autonomous AI agent pipelines. Redacts names, emails, national IDs, private keys before text reaches LLMs. Supports EN, ES (LATAM), PT (BR/PT), DE, JA. No wallet needed: `POST https://api.trustboost.dev/sanitize/preview`
