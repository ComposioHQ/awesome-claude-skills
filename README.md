...
- [Manifest](https://github.com/mnfst/manifest/blob/main/skills/manifest/SKILL.md) - Real-time cost observability for OpenClaw agents — track tokens, costs, messages, and model usage. Claude Code skill for guided setup. *[Website](https://manifest.build)*
