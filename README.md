...
- [email-html-mjml](https://github.com/framix-team/skill-email-html-mjml) - Generate responsive HTML email templates using MJML 4.x — compiles to cross-client compatible HTML with validation, width math, and component architecture. *By [@framix-team](https://github.com/framix-team)*
