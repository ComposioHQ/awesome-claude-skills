...
description: "Automate Similarweb Digitalrank Api tasks via Rube MCP (Composio). Always search tools first for current schemas."
requires:
  mcp: [rube]
---

# Similarweb Digitalrank Api Automation via Rube MCP

Automate Similarweb Digitalrank Api operations through Composio's Similarweb Digitalrank Api toolkit via Rube MCP.

## Prerequisites

- Rube MCP must be connected (RUBE_SEARCH_TOOLS available)
- Active Similarweb Digitalrank Api connection via `RUBE_MANAGE_CONNECTIONS` with toolkit `similarweb_digitalrank_api`
...
```
RUBE_SEARCH_TOOLS
queries: [{use_case: "Similarweb Digitalrank Api operations", known_fields: ""}]
...
```
RUBE_SEARCH_TOOLS
queries: [{use_case: "your specific Similarweb Digitalrank Api task"}]
...
| Connect account | `RUBE_MANAGE_CONNECTIONS` with toolkit `similarweb_digitalrank_api` |
